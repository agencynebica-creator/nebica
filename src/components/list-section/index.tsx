...
const ListSection = () => (
  <section className={tw(`lg:py-10 pt-10 overflow-hidden relative`)} style={{
    ...
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-4 lg:p-0`)}>
      <div className={tw(`mb-4 text-center`)}>
        <p className={tw(`mt-2 pb-4 text-4xl lg:text-5xl font-bold tracking-tight text-indigo-500`)}>
      ...
      <div className={tw(`flex flex-wrap -mx-8 items-center`)}>
        ...
        <div className={tw(`w-full lg:w-1/2 px-8`)}>
          <div className={tw(`lg:mb-12 lg:mb-0 pb-12 lg:pb-0 mt-16 lg:mt-0 mx-6 lg:mx-0 rounded-lg overflow-hidden shadow-xl`)}>
            <img 
              src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" 
              alt="Professional team collaboration" 
              className={tw(`w-full h-auto object-cover rounded-lg`)}
