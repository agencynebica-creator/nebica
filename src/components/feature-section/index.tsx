...
const FeatureSection = () => (
  <section  className="relative pb-6 mx-auto  bg-white bg-opacity-80 backdrop-blur-sm rounded-lg" style={{
    ...
    <div  className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
      <div  className="container mx-auto px-6 p-6">
        <div  className="mb-16 text-center">
          <p  className="mt-2 text-4xl lg:text-6xl font-bold tracking-tight text-indigo-500">
        ...
        <div  className="flex flex-wrap my-12">
          <div  className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8">
            <div  className="flex items-center mb-6">
              ...
              <div  className="ml-4 text-xl">Verified Talent Pool</div>
            </div>
          ...
          <div  className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8">
            <div  className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor"  className="h-6 w-6 text-indigo-500" />
              <div  className="ml-4 text-xl">Cost-Effective Solutions</div>
            </div>
            <p  className="leading-loose text-gray-500 ">
          ...
          <div  className="w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8">
            <div className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor"  className="h-6 w-6 text-indigo-500" />
              <div  className="ml-4 text-xl">Fast Time-to-Hire</div>
            </div>
            <p  className="leading-loose text-gray-500">
          ...
          <div  className="w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8">
            <div  className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor"  className="h-6 w-6 text-indigo-500" />
              <div  className="ml-4 text-xl">24/7 Availability</div>
            </div>
            <p  className="leading-loose text-gray-500">
          ...
          <div  className="w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8">
            <div  className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor"  className="h-6 w-6 text-indigo-500" />
              <div  className="ml-4 text-xl">Dedicated Support</div>
            </div>
            <p  className="leading-loose text-gray-500">
          ...
          <div  className="w-full md:w-1/2 lg:w-1/3 p-8">
            <div  className="flex items-center mb-6">
              <Check width={20} height={20} fill="currentColor"  className="h-6 w-6 text-indigo-500" />
              <div  className="ml-4 text-xl">Instant Replacement</div>
            </div>
            <p  className="leading-loose text-gray-500">
